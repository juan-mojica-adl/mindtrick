import { r as registerInstance, h } from './core-14fa86c3.js';
...
const MyComponent = class {
    ...
    format() {
        return hooks("1995-12-25").format('LLL');
    }
    render() {
        return (h("div", null, h("p", null, h("input", { ref: el => this.textInitYear = el, id: "initYear", type: "text", placeholder: "yyyy", onKeyPress: (e) => this.deleteInitialMonth(e) }), h("input", { ref: el => this.textInitMonth = el, disabled: true, onKeyPress: (e) => this.deleteInitialDay(e), id: "initMonth", name: "mon", type: "text", placeholder: "MM" }), h("input", { ref: el => this.textInitDay = el, disabled: true, onKeyPress: (e) => this.deleteEndYear(e), id: "initDay", type: "text", placeholder: "DD" }), h("div", null, this.format())), h("p", null, h("input", { ref: el => this.textEndYear = el, disabled: true, onKeyPress: (e) => this.deleteEndMonth(e), id: "endYear", type: "text", placeholder: "yyyy" }), h("input", { ref: el => this.textEndMonth = el, disabled: true, onKeyPress: (e) => this.deleteEndDay(e), id: "endMonth", type: "text", placeholder: "MM" }), h("input", { ref: el => this.textEndDay = el, disabled: true, id: "endDay", type: "text", placeholder: "DD" }))));
